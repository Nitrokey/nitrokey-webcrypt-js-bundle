...
var require_cbor = __commonJS({
  "js/vendor/cbor.js"(exports, module2) {
    "use strict";
...
// index.ts
var webcrypt_js_lib_exports = {};
__export(webcrypt_js_lib_exports, {
  CommandChangePinParams: () => CommandChangePinParams,
  CommandDecryptParams: () => CommandDecryptParams,
  CommandDecryptReturn: () => CommandDecryptReturn,
  CommandGenerateKeyFromDataParams: () => CommandGenerateKeyFromDataParams,
  CommandGenerateKeyFromDataReturn: () => CommandGenerateKeyFromDataReturn,
  CommandGenerateKeyReturn: () => CommandGenerateKeyReturn,
  CommandGenerateResidentKeyReturn: () => CommandGenerateResidentKeyReturn,
  CommandGetConfigurationReturn: () => CommandGetConfigurationReturn,
  CommandInitializeSeedParams: () => CommandInitializeSeedParams,
  CommandInitializeSeedReturn: () => CommandInitializeSeedReturn,
  CommandLoginParams: () => CommandLoginParams,
  CommandLoginReturn: () => CommandLoginReturn,
  CommandReadResidentKeyPublicParams: () => CommandReadResidentKeyPublicParams,
  CommandReadResidentKeyPublicReturn: () => CommandReadResidentKeyPublicReturn,
  CommandRestoreFromSeedParams: () => CommandRestoreFromSeedParams,
  CommandRestoreFromSeedReturn: () => CommandRestoreFromSeedReturn,
  CommandSetConfigurationParams: () => CommandSetConfigurationParams,
  CommandSetPinParams: () => CommandSetPinParams,
  CommandSignParams: () => CommandSignParams,
  CommandSignReturn: () => CommandSignReturn,
  CommandStatusReturn: () => CommandStatusReturn,
  CommandTestPingParams: () => CommandTestPingParams,
  CommandTestPingReturn: () => CommandTestPingReturn,
  CommandWriteResidentKeyParams: () => CommandWriteResidentKeyParams,
  CommandWriteResidentKeyReturn: () => CommandWriteResidentKeyReturn,
  WEBCRYPT_ENCRYPT: () => WEBCRYPT_ENCRYPT,
  WEBCRYPT_GENERATE: () => WEBCRYPT_GENERATE,
  WEBCRYPT_GENERATE_FROM_DATA: () => WEBCRYPT_GENERATE_FROM_DATA,
  WEBCRYPT_LOGIN: () => WEBCRYPT_LOGIN,
  WEBCRYPT_OPENPGP_DECRYPT: () => WEBCRYPT_OPENPGP_DECRYPT,
  WEBCRYPT_OPENPGP_GENERATE: () => WEBCRYPT_OPENPGP_GENERATE,
  WEBCRYPT_OPENPGP_IMPORT: () => WEBCRYPT_OPENPGP_IMPORT,
  WEBCRYPT_OPENPGP_INFO: () => WEBCRYPT_OPENPGP_INFO,
  WEBCRYPT_OPENPGP_SIGN: () => WEBCRYPT_OPENPGP_SIGN,
  WEBCRYPT_SIGN: () => WEBCRYPT_SIGN,
  WEBCRYPT_STATUS: () => WEBCRYPT_STATUS,
  WEBCRYPT_VERIFY: () => WEBCRYPT_VERIFY,
  Webcrypt_ChangePin: () => Webcrypt_ChangePin,
  Webcrypt_Decrypt: () => Webcrypt_Decrypt,
  Webcrypt_DiscoverResidentKeys: () => Webcrypt_DiscoverResidentKeys,
  Webcrypt_FactoryReset: () => Webcrypt_FactoryReset,
  Webcrypt_GenerateKey: () => Webcrypt_GenerateKey,
  Webcrypt_GenerateKeyFromData: () => Webcrypt_GenerateKeyFromData,
  Webcrypt_GenerateResidentKey: () => Webcrypt_GenerateResidentKey,
  Webcrypt_GetConfiguration: () => Webcrypt_GetConfiguration,
  Webcrypt_InitializeSeed: () => Webcrypt_InitializeSeed,
  Webcrypt_Login: () => Webcrypt_Login,
  Webcrypt_Logout: () => Webcrypt_Logout,
  Webcrypt_ReadResidentKeyPublic: () => Webcrypt_ReadResidentKeyPublic,
  Webcrypt_RestoreFromSeed: () => Webcrypt_RestoreFromSeed,
  Webcrypt_SetConfiguration: () => Webcrypt_SetConfiguration,
  Webcrypt_SetPin: () => Webcrypt_SetPin,
  Webcrypt_Sign: () => Webcrypt_Sign,
  Webcrypt_Status: () => Webcrypt_Status,
  Webcrypt_TestClear: () => Webcrypt_TestClear,
  Webcrypt_TestPing: () => Webcrypt_TestPing,
  Webcrypt_TestReboot: () => Webcrypt_TestReboot,
  Webcrypt_WriteResidentKey: () => Webcrypt_WriteResidentKey,
  byteToHexString: () => byteToHexString,
  hexStringToByte: () => hexStringToByte,
  session: () => session
});
module.exports = __toCommonJS(webcrypt_js_lib_exports);
